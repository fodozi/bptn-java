	...
	// Test case to check if a year is a leap year
	  ...
	  public void testLeapYear() {
	    ...
	    //Verify if the actual result is equal to the expected result using assertTrue()
		  assertTrue(actualResult == expectedResult, "The year" + year + "should be a leap year.");
...
public void testNotLeapYear() {
	 ...
	 boolean actualResult = LeapYearTest.isLeapYear(year);
  
     //Verify if the actual result is equal to the expected result using assertTrue()
	 assertTrue(actualResult == expectedResult, "The year " + year + " should not be a leap year.");
}
